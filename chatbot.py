...
def add_bg_from_local(image_file):
    ...
    st.title("***CHATBOT FOR CUSTOM DATA***")
    st.markdown(
    f"""
    <style>
    .stApp {{
...
#uploaded_file = st.sidebar.file_uploader("Upload file here for personal chatbot: ", type="txt")
...
###-------------------------------------Tabs start here-----------------------------------
personal_chatbot = st.tabs(["Personal chatbot"])
